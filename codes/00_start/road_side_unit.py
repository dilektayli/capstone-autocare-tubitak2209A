# This code is an example of a basic implementation of communication modules for Dedicated Short Range Communication (DSRC) between vehicles and a Road Side Unit (RSU).
# The communication is done using User Datagram Protocol (UDP) sockets in Python.
## some issue with closing the program at the end !!!
